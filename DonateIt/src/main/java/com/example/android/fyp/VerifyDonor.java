...
public class VerifyDonor extends AppCompatActivity {
        ...
        btnVerify.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (email.isEmpty() || verifyCode.isEmpty()) {
                    Toast.makeText(VerifyDonor.this, "Fill all fields..", Toast.LENGTH_SHORT).show();
                } else {
    ...
    private class databaseProcessForOrg extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            String link = currentUrl+"DonateIt/verify_donor.php?email="+email+"&code="+verify;
        ...
        protected void onPostExecute(String result) {
            try{
                ...
                if(success.equalsIgnoreCase("true")) {
                    Toast.makeText(VerifyDonor.this, jsonObject.getString("message"), Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(VerifyDonor.this, ActivityValidationReg.class);
