...
public class ForgotPasswordOrg extends Fragment {
    ...
    public View onCreateView(final LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.activity_forgot_password_org, container, false);
    ...
    private class databaseProcessForOrg extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            String link = currentUrl+"DonateIt/forgotPasswordOrg.php?email="+email;
